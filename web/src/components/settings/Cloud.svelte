...
<div class="settings-section">
  <div class="settings-group">
    ...
    <div class="integration-card">
      <div class="integration-desc">
        Connect your agent to <strong>Residuum Cloud</strong> for remote access via a
        personal subdomain. Your agent becomes accessible from anywhere without port
        forwarding or VPN setup.
      </div>
  ...
  {#if cloudStatus?.has_token || fields.cloud_token}
    <div class="settings-group">
